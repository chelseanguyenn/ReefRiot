...
//   .movable-shark[data-state="disrupting"] .shark-bubble {
//     border-color: #ff2dff44;
//   }
...
//   .movable-shark[data-state="moving"] .shark-svg {
//     animation: sharkSwim 0.4s ease-in-out infinite alternate;
//   }

//   .movable-shark[data-state="disrupting"] .shark-svg {
//     animation: sharkCharge 0.2s ease-in-out infinite alternate;
//     filter: drop-shadow(0 0 8px #ff2dffaa);
//   }

//   .movable-shark[data-state="restored"] .shark-svg {
//     animation: sharkCelebrate 0.8s ease-in-out infinite alternate;
//     filter: drop-shadow(0 0 10px #39ff14cc);
//   }
...
//   /* Interact prompt bubble above shark */
//   .interact-prompt {
//     position: absolute;
//     top: -28px;
//     left: 50%;
...
// export default function MovableShark({ x, y, facing, state, nearNode }) {
//   return (
//     <>
//       <style>{styles}</style>
//       <div
...
//         }}
//       >
//         {nearNode && <div className="interact-prompt">E — DISRUPT</div>}
...
export default function MovableShark({
  x,
  y,
  facing,
  state,
  ...
  const hp = Math.max(1, Math.ceil(health / 34));
  ...
  return (
    ...
    >
      ...
      <SharkAvatar state={state} hp={hp} maxHp={3} />
    </div>
  );
}